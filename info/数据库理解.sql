...
/**
    ...
    注重表与表之间的联系
    (1)商品分类存在继承关系——"电子书刊"分类的父类是"图书、音像、电子书刊"
    (2)商品肯定属于某个分类，肯定属于某个品牌
    (3)一个分类下有多个规格组——"手机"分类下肯定有"屏幕"、"内存"等多个规格组
    (4)一个规格组下面有多个规格参数——"主体"下有"品牌"、"型号"和"上市年份"
**/
...
CREATE TABLE `tb_spu` (                                                                                                                 
    ...
    PRIMARY KEY (`id`)                                                                                                                    
) ENGINE=InnoDB AUTO_INCREMENT=196 DEFAULT CHARSET=utf8 COMMENT='spu表，该表描述的是一个抽象性的商品，比如 iphone8'  
...
) ENGINE=InnoDB AUTO_INCREMENT=27359021730 DEFAULT CHARSET=utf8 COMMENT='sku表,该表表示具体的商品实体,如黑色的 64g的iphone 8'          
...
) ENGINE=InnoDB AUTO_INCREMENT=126 DEFAULT CHARSET=utf8 COMMENT='订单详情表'  
